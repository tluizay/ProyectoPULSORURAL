...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!formCalculadora || !botonCalcular) return;
    ...
    botonCalcular.addEventListener("click", function () {
        ...
        .then(data => {
            document.getElementById("res-produccion").textContent = `${data.produccion_total_kg.toLocaleString()} kg`;
            document.getElementById("res-ingreso").textContent = `${data.ingreso_total.toLocaleString()} €`;
            document.getElementById("res-coste").textContent = `${data.coste_total.toLocaleString()} €`;
            document.getElementById("res-margen").textContent = `${data.margen_total.toLocaleString()} €`;
            document.getElementById("res-margen-ha").textContent = `${data.margen_por_ha.toLocaleString()} €/ha`;
        })
        .catch(error => {
